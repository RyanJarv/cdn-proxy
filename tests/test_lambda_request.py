...
headers = {
    "host": [{"key": "Host", "value": "dldsnpcikv3j3.cloudfront.net"}],
    ...
    "x-forwarded-for": [{"key": "X-Forwarded-For", "value": "76.121.136.156"}],
    "user-agent": [
        {
            "key": "User-Agent",
    ...
    "if-none-match": [{"key": "If-None-Match", "value": '"3147526947"'}],
    "if-modified-since": [
        {"key": "If-Modified-Since", "value": "Thu, 17 Oct 2019 07:18:26 GMT"}
    ],
}
